...
* Script python pour la stylométrie. Le script calcule la proximité entre les textes au format .txt d'un dossier selon 5 distances utilisées en stylométrie. Les paramètres à modifier figurent au début du script.
